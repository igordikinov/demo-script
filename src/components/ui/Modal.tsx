...
export function Modal({
  ...
  useEffect(() => {
    ...
    return () => {
      // isConnected: опенер мог размонтироваться в том же коммите, что и окно
      // (§4.8:329, DN-ysk) — «Добавить в мои» закрывает окно и открывает
      // сценарий, а кнопка загрузки живёт в каталоге (§4.2:247). Фокус на
      // оторванном узле ничего не делает, но и звать его незачем.
