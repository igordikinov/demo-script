...
// «Загрузить из Excel» (§4.1:236), neutral — «Отмена», ‹ › (§4.5),
// destructive — «Удалить» (§4.2:253). Стили выбираются по data-variant и
// data-icon-only: так вариант виден и в тестах, где классы CSS-модулей —
// прокси-строки. Своего текста у кнопки нет — подписи передаёт потребитель.
import { forwardRef, type ButtonHTMLAttributes, type ReactNode } from 'react';
import styles from './Button.module.css';

export type ButtonVariant = 'primary' | 'stroked' | 'neutral' | 'destructive';
